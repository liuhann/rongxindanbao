...
function drawDateBar(until) {
    ...
    .attr('height', function (d) {
      return (h-space) - yRange(d.l/(60*60*1000)); 
    })
    .attr('y', function (d) {
