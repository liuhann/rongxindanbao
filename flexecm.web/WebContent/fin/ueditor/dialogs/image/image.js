    ...
    */
    ...
    var NetWork = {
        ...
        initEvt: function () {
            ...
            $.getJSON("/service/attachz/upload/list", {}, function(result) {
            	for(var i=0; i<result.list.length; i++) {
            		var url = "/service/attachz/preview?id=" + result.list[i].uid;
            		
					$("<img src='" + url + "' class='edui-image-pic' />").data("uid", result.list[i].uid).on("load", function() {
                        ...
                        $item.find(".edui-image-close").click(function() {
                        	var data = $(this).siblings("img.edui-image-pic").data("uid");
                        ...
                        $item.find(".edui-image-pic").click(function() {
                        	if ($(this).hasClass("checked")) {
                        		$(this).removeClass("checked");
                        		$(this).parents(".edui-image-item").css("border", "1px solid #ccc");
                        	} else {
                        		$(this).parents(".edui-image-item").css("border", "2px solid blue");
    ...
    UM.registerWidget('image', {
        tpl: "<link rel=\"stylesheet\" type=\"text/css\" href=\"<%=image_url%>image.css\">" +
            ...
            "<div class=\"edui-image-JimgSearch edui-tab-pane\" style=\"display:block;\">" +
            ...
            'ok': {
                exec: function (editor, $w) {
                    ...
                    if (index == 0) {
                        ...
                        sel = ".edui-image-searchRes .edui-image-pic.checked";
                    }
